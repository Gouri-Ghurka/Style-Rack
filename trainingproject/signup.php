    ...
    <!-- Main -->
        <div class="content">
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                  <img src="./img/signup.jpg" class="img-responsive signup-image" alt="Image">
              </div>
              <div class="col-md-6">
                  <h1>Sign Up</h1>
                  <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="tel" class="form-control" name="contact" placeholder="Contact" pattern="[789][0-9]{9}"
                                    title="Format:(7/8/9)xxxxxxxxx" required>
                                <?php
                                if(isset($_GET['m2'])){
                                 echo $_GET['m2'] ;
                                }
